...
### Changed
- Updated kubelogin from v0.0.29 to v0.2.17
- Updated Go version from 1.15 to 1.26
- Migrated from deprecated `ioutil.ReadFile` to `os.ReadFile`
- Consolidated apt-get, wget, and unzip into single RUN layer in Dockerfile
